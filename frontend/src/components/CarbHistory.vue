    ...
    <div class="card-body p-0">
      <div class="p-4 pb-2 flex items-center justify-between">
        <div class="flex items-center gap-2">
          ...
          <span class="text-[9px] uppercase font-black tracking-widest opacity-40">{{ $t('carbs.historyTitle') }}</span>
        </div>
          ...
          >
            ...
            <div v-else class="flex flex-col gap-2 p-1">
              <div class="flex items-center justify-between px-1">
                <span class="text-[8px] font-black uppercase opacity-40">{{ $t('carbs.editTitle') }}</span>
                <span class="text-[10px] font-black text-accent">{{ editForm.amount }}{{ $t('common.gramSymbol') }}</span>
                <button @click="editingId = null" class="btn btn-ghost btn-xs h-4 min-h-0 text-[8px] uppercase">{{ $t('common.cancel') }}</button>
              </div>
